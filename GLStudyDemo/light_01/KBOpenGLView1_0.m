...
@implementation KBOpenGLView1_0
...
-(void)loadCube{
    ...
    glBindVertexArrayOES(VAO_1);
    glVertexAttribPointer([lampShader attributeIndex:@"position"], 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat), (GLvoid*)0);
