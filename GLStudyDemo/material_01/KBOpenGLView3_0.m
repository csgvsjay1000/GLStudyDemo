...
//  GLStudyDemo
//
//  Created by chengshenggen on 8/19/16.
...
-(void)drawLights{
    ...
    //    model = GLKMatrix4TranslateWithVector3(model, GLKVector3Make(1.2, 1, 2));
    ...
    GLKVector3 cameraPos = GLKVector3Make(1, 1, -z);
    GLKVector3 cameraFront = GLKVector3Make(-1, -1, z);   // Z 轴
    
    GLKVector3 temp = GLKVector3Make(0, z, 1);  // X 轴
